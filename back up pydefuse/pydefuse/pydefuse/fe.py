...
import numpy
import pydefuse.gui as gui
import pydefuse.mesher as mesher
    ...
    def create_mesh(self,cartcoords,deltastrengths):
        ...
        if self.params.prerefine:
            ...
            if self.pbc != [False, False, False]:
                ...
                self.V = FunctionSpace(self.msh, "CG", self.params.element_order)
        P1 = FiniteElement("P", self.msh.ufl_cell(), self.params.element_order)
        element = MixedElement([P1,P1])
        self.W = W = FunctionSpace(self.msh, element)
        #plot(self.msh)
        #interactive()
